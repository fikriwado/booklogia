      ...
      <section className="padding-y-xxl position-relative z-index-1 pt-3 pb-5">
        <div className="container max-width-adaptive-sm position-relative z-index-2">
          <div className="text-component margin-bottom-sm pt-5">
            <h1>Solusi bertahan di industry 4.0 </h1>
            <p>Booklogia / 10 Sep 2021</p>
          </div>
        </div>

        <div className="container pt-3">
          <img
            src="https://cdn0-production-images-kly.akamaized.net/oqVK1UmRUMoQzNjpGNo2ATFQXzE=/0x72:999x635/640x360/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/3613377/original/028028000_1635234422-shutterstock_1702787302.jpg"
            alt=""
