            ...
            <Col lg={7} className="order-lg-1">
              <div className="text-center text-lg-start">
                ...
                <p className="w-75 lh-lg mb-4 mx-auto mx-lg-0">
                  ...
                  penggemar buku yang mencari bacaan baru untuk koleksinya
                  maupun pembaca santai yang ingin mencari bacaan diwaktu
                  senggang mereka.
                </p>
        ...
        <Container className="py-lg-3 text-center">
          <Row className="mb-lg-4">
            <Col>
              ...
              <p>
                Berbagai bacaan yang sedang ramai dibaca dapat kamu akses
                disini.
              </p>
            </Col>
          </Row>
            ...
            <Col lg={4} className="mb-3 mb-lg-0">
              <Card className="rounded-0 bg-light border-light h-100 py-3">
                <Card.Body>
                  ...
                  <Card.Text>
                    Web ini sungguh menarik, aku bisa tahu buku-buku menarik
                    setelah mengetahui ulasan dari para pengguna lain dan web
            ...
            <Col lg={4} className="mb-3 mb-lg-0">
              <Card className="rounded-0 bg-light border-light h-100 py-3">
                <Card.Body>
                  ...
                  <Card.Text>
                    Orang-orang disini sangat supportive, mereka dengan senang
                    hati memberikan rekomendasi buku yang menarik.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
