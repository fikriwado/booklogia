                        ...
                        <Nav className="align-items-center">
                            {isAuthorized ? (
                                ...
                                <>
                                    <Link
                                        to="/login"
                                        className="me-lg-2 w-100 w-lg-auto mb-2 mb-lg-0">
                                        <Button
                                            variant="outline-light"
                                            className="px-lg-4 py-lg-2 w-100 w-lg-auto">
                                            Login
                                        </Button>
                                    </Link>

                                    <span className="nav-link me-2 d-none d-lg-inline-block">
                                        or
                                    </span>
                                    ...
                                    <Link to="/register" className="w-100 w-lg-auto">
                                        <Button
                                            variant="orange"
                                            className="px-lg-4 py-lg-2 w-100 w-lg-auto text-light">
                                            Register
                                        </Button>
                                    </Link>
                                </>
