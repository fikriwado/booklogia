		...
		<footer className="bg-dark text-light py-5">
			<Container>
				<Row>
					...
					<Col md={3} className="ps-xl-5 mt-3">
					...
					<Col md={3} className="pe-xl-5 mt-3">
						<h5 className="text-uppercase mb-4 font-weight-bold">About</h5>
						<p>Buku sering disebut sebagai jendela dunia karena dengan membaca buku kita dapat mengetahui apa saja yang ada di dunia ini baik dimasa sekarang bahkan dimasa lampau, kuncinya hanyalah membaca.</p>
					</Col>
					
                    <hr className="w-100 bg-secondary d-md-none" />

					<Col md={3} className="ps-xl-4 mt-3">
				...
				<Row className="align-items-center">
					<Col md={6} className="text-center text-md-start">
                        ...
                        <a className="text-white text-decoration-none"href="https://google.com/">BookLogia</a>
					</Col>
					
					<Col md={6} className="text-center text-md-end">
						<a className="btn m-1 text-white" role="button" href="https://www.instagram.com/">
							<i className="fab fa-instagram  icon-media-footer"></i>
						</a>

						<a className="btn m-1 text-white" role="button" href="https://www.facebook.com/">
